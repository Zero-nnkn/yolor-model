...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            print('best_p:', best_fitness_p)
            print('best_r:',best_fitness_r)
            print('best_ap50:', best_fitness_ap50)
            print('best_ap:', best_fitness_ap)
            print('best_f:', best_fitness_f)
...
if __name__ == '__main__':
    ...
    if opt.resume:  # resume an interrupted run
        ...
        opt.save_dir = '/content/drive/MyDrive/Colab Notebooks/OD/yolor/runs/train/yolor_w6'
